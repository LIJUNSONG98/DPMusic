...
__DEFINE__(1689664181733, function(require, module, exports) {
module.exports = {
  JSEventBus: require("./event-bus"),
  JSEventStore: require("./event-store"),
};

}, function(modId) {var map = {"./event-bus":1689664181734,"./event-store":1689664181735}; return __REQUIRE__(map[modId], modId); })
__DEFINE__(1689664181734, function(require, module, exports) {
class JSEventBus {
  constructor() {
    this.eventBus = {};
  }
...
__DEFINE__(1689664181735, function(require, module, exports) {
...
}, function(modId) { var map = {"./event-bus":1689664181734,"./utils":1689664181736}; return __REQUIRE__(map[modId], modId); })
__DEFINE__(1689664181736, function(require, module, exports) {
...
return __REQUIRE__(1689664181733);
})()
